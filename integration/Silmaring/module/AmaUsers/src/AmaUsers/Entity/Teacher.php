...
class Teacher
{
    ...
    /**
     * @var string
     * @ORM\ManyToOne(targetEntity="AmaSchools\Entity\School", inversedBy="teachers")
    ...
    /**
     * @var array $classes
     * @ORM\OneToMany(targetEntity="AmaUsers\Entity\TeacherClass", mappedBy="teacher", cascade={"remove"}, orphanRemoval=true)
     */
    protected $classes;

    /**
     * @var array $teacherUsers
     * @ORM\OneToMany(targetEntity="AmaUsers\Entity\UserTeacher", mappedBy="teacher", cascade={"remove"}, orphanRemoval=true)
     */
    protected $teacherUsers;
    ...
    public function __construct()
    {
        ...
        $this->teacherUsers = new ArrayCollection();
    }
    ...
    /**
     * @param \AmaUsers\Entity\TeacherClass $class
     */
    public function removeClass(TeacherClass $class)
    {
    ...
    public function getFirstTeacherUser()
    {
        return $this->teacherUsers[0];
    }
}
