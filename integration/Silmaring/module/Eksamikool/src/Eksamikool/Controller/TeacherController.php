...
use Eksamikool\Form\SubsubjectForm;
use Eksamikool\Filter\SubsubjectFilter;

use Eksamikool\Model\Lesson;
use Eksamikool\Form\LessonForm;
use Eksamikool\Filter\LessonFilter;
...
use Eksamikool\Form\HomeworkForm;
use Eksamikool\Filter\HomeworkFilter;

use Eksamikool\Service\EmailService;

use Eksamikool\Model\HomeworkAnswers;

use Eksamikool\Form\FeedbackForm;
...
class TeacherController extends AbstractActionController {
	...
	public function indexAction() {
		...
		$user = $this->identity();
		$course = $this->getCourseTable()->getCourseByTeacherId($user->getId());
	...
	public function myCourseAction() {
		...
		if ($course->teacher_id == $user->getId()) {
			$subjects = $this->getSubjectTable()->getSubjectsByCourseId($course->id);
	...
	public function homeworksAction() {
		...
		$homeworks = $this->getHomeworkTable()->getHomeworkByUserId($user->getId());
