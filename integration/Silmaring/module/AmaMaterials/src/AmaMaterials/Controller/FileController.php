...
class FileController extends AbstractActionController
{
    ...
    public function addAction()
    {
        ...
        $htmlViewPart->setTerminal(true)
            ...
            ->setTemplate("ama-materials/file/add");
        ...
        return new JsonModel(array(
            'success' => true,
            'html' => $htmlOutput,
            'title' => $translator->translate("Add File")
        ));
    }
    ...
    public function addAjaxAction()
    {
        ...
        if ($request->isPost()) {
            ...
            if ( $form->isValid() ) {
                ...
                $form->getData()->setType($file::TYPE_FILE);
                ...
                $lessonPlanFile->setType($file::TYPE_FILE);
    ...
    public function selectAction()
    {
        ...
        $materials = $this->getEntityManager()->getRepository('AmaMaterials\Entity\File')->findFilesByType($start, $limit, 'file');
        ...
        $htmlViewPart->setTerminal(true)
            ...
            ->setTemplate("ama-materials/file/select");
