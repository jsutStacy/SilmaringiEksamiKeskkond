...
class VideoController extends AbstractActionController
{
    ...
    public function addAction()
    {
        ...
        $htmlViewPart->setTerminal(true)
            ...
            ->setTemplate("ama-materials/video/add");
        ...
        return new JsonModel(array(
            'success' => true,
            'html' => $htmlOutput,
            'title' => $translator->translate("Add Video")
        ));
    }
    ...
    public function addAjaxAction()
    {
        ...
        if ($request->isPost()) {
            ...
            $form->setData($post);
            $form->getInputFilter()->get('video')->setRequired(true);
            ...
            if ( $form->isValid() ) {
                ...
                $form->getData()->setType($file::TYPE_VIDEO);
                ...
                $lessonPlanFile->setType($file::TYPE_VIDEO);
    ...
    public function selectAction()
    {
        ...
        $materials = $this->getEntityManager()->getRepository('AmaMaterials\Entity\File')->findFilesByType($start, $limit, 'video');
        ...
        $htmlViewPart->setTerminal(true)
            ...
            ->setTemplate("ama-materials/video/select");
