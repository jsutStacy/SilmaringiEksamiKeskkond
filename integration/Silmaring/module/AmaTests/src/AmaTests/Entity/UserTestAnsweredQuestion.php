 ...
 * @ORM\Entity
 * @ORM\Table(name="test_user_answered_question")
 */
class UserTestAnsweredQuestion
{
    /**
     * @var int
     * @ORM\Id
    ...
    /**
     * @var string
     * @ORM\ManyToOne(targetEntity="AmaMaterials\Entity\LessonPlanFile", inversedBy="userTestAnsweredQuestions")
    ...
    /**
     * @var string
     * @ORM\ManyToOne(targetEntity="AmaMaterials\Entity\FileClass", inversedBy="testUserAnsweredQuestions")
     ...
     * @ORM\OneToMany(targetEntity="AmaTests\Entity\UserTestAnswer", mappedBy="answeredQuestion", cascade={"remove"}, orphanRemoval=true)
     */
