...
class IndexController extends AbstractActionController
{
    ...
    public function indexAction()
    {
        ...
        $materials = $this->getEntityManager()->getRepository('AmaTests\Entity\Test')->findTests($user, '', '', $args);
        $materialsCount = $this->getEntityManager()->getRepository('AmaTests\Entity\Test')->findTestsCount($user, '', '', $args);
    ...
    public function pageAction()
    {
        ...
        $viewModel->setTemplate('ama-tests/index/index');
    ...
    public function categoryAction()
    {
        ...
        $materials = $this->getEntityManager()->getRepository('AmaTests\Entity\Test')->findTests($user, $categories, $category->getId(), $args);
        $materialsCount = $this->getEntityManager()->getRepository('AmaTests\Entity\Test')->findTestsCount($user, $categories, $category->getId(), $args);
    ...
    public function selectAction()
    {
        ...
        $materials = $this->getEntityManager()->getRepository('AmaMaterials\Entity\File')->findFilesByType($start, $limit, 'test');
        ...
        $htmlViewPart->setTerminal(true)
            ...
            ->setTemplate("ama-tests/index/select");
